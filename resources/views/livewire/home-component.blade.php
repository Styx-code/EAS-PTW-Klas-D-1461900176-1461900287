            ...
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
                <div class="item-slide">
                    ...
                    <div class="slide-info slide-1">
                        <h2 class="f-title">Produk 1 <b>UWU</b></h2>
                        <span class="subtitle">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illo, neque?</span>
                        <p class="sale-info">Harga: <span class="price">Rp. 150.000</span></p>
                ...
                <div class="item-slide">
                    ...
                    <div class="slide-info slide-2">
                        <h2 class="f-title">Extra Diskon 25%</h2>
                        <span class="f-subtitle">Untuk pembayaran online</span>
                        <p class="discount-code">Pakai Kode: #FA6868</p>
                    </div>
                </div>
                {{-- <div class="item-slide">
            ...
            <div class="wrap-products">
                <div class="wrap-product-tab tab-style-1">
                    <div class="tab-control">
                        <a href="#fashion_1a" class="tab-control-item active">Fashion Pria</a>
                        <a href="#fashion_1b" class="tab-control-item">Fashion Wanita</a>
                        <a href="#fashion_1c" class="tab-control-item">Aksesoris</a>
                        <a href="#fashion_1d" class="tab-control-item">Lainnya</a>
                    </div>
                    <div class="tab-contents">
